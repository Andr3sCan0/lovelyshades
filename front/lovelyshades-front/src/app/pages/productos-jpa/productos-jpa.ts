...
import { ProductoJpaService } from '../../services/producto-jpa.service';

@Component({
  selector: 'app-productos-jpa',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './productos-jpa.html',
  styleUrl: './productos-jpa.scss'
})
export class ProductosJpaComponent implements OnInit {
  ...
  listarProductos(): void {
    this.productoJpaService.listar()
      .subscribe(data => {
        this.productos = data;
        this.aplicarFiltros();
      });
  ...
  guardar(): void {
    ...
    if (this.editando) {
      this.productoJpaService.actualizar(this.producto)
        .subscribe(() => {
          this.listarProductos();
      ...
      this.productoJpaService.crear(this.producto)
        .subscribe(() => {
          this.listarProductos();
          this.limpiarFormulario();
  ...
  eliminar(id: number | undefined): void {
    ...
    if (confirm('¿Está seguro de que desea eliminar este producto?')) {
      this.productoJpaService.eliminar(id)
        .subscribe(() => {
          this.listarProductos();
